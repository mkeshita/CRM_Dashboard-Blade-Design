...
class CreateLandFillingStatus1stsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('land_filling_status1sts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('land_filling_status1sts');
    }
}
