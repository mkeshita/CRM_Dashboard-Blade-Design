    ...
    <div class="container-fluid">
        <div class="card p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div>
                    <button class="btn btn-sky-blue px-3" data-bs-toggle="modal" data-bs-target="#addSuperAdminModal">Add
                        Super Admin</button>
                </div>
            </div>
        ...
        <div class="modal fade" id="addSuperAdminModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable custom-modal">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title flex-grow-1 text-center fw-normal" id="exampleModalLabel">Add Super Admin
                        </h5>
                    ...
                    <div class="modal-body px-4">
                        <form action="">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Super Admin Name</label>
                                <input type="text" class="form-control p-2 px-3" placeholder="Enter Super Admin Name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Super Admin Image</label>
                                <input onchange="loadImage(event)" class="form-control mb-2" type="file" id="formFile">
                                <img id="super-admin-image-preview" accept="image/*" style="height: 150px;"
...
@section('script')
    ...
    <script>
        var loadImage = function(event) {
            var image = document.getElementById('super-admin-image-preview');
