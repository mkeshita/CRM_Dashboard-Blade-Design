    ...
    <div class="container-fluid">
        <div class="card p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div>
                    <button class="btn btn-sky-blue px-3" data-bs-toggle="modal" data-bs-target="#addEmployeeModal">Add
                        Employee</button>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable custom-modal">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title flex-grow-1 text-center fw-normal" id="exampleModalLabel">Add Employee
                        </h5>
                    ...
                    <div class="modal-body px-4">
                        <form action="">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control p-2 px-3" placeholder="Enter Employee Name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Employee Image</label>
                                <input onchange="loadImage(event)" class="form-control mb-2" type="file" id="formFile">
                                <img id="employee-image-preview" accept="image/*" style="height: 150px;"
...
@section('script')
    ...
    <script>
        var loadImage = function(event) {
            var image = document.getElementById('employee-image-preview');
