        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card bg-secondary">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Here you can find Car Parking, Registration & Khajna</p>
                        <form method="GET" action=" @if (Auth::guard('super_admin')->check()) {{route('super_admin.car.parking.single.show')}} @endif">
